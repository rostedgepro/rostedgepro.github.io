...
<head>
    ...
    <style>
        :root {
            ...
            --bg-color-start: #f8fafc; /* slate-50 */
            --bg-color-end: #f0f5ff; /* A custom light blue */
            --bg-color: #f8fafc; /* Fallback */
            --bg-color-2: #ffffff; /* white for cards, inputs */
            --text-primary: #0f172a; /* slate-900 */
            --text-secondary: #64748b; /* slate-500 */
            --accent-color: #4f46e5; /* indigo-600 */
            --accent-glow: rgba(79, 70, 229, 0.2);
            --card-bg: rgba(255, 255, 255, 0.7);
            --border-color: rgba(226, 232, 240, 0.9); /* slate-200 */
            --shadow-color: rgba(99, 102, 241, 0.1); /* indigo-500 based */
            --icon-color: #475569; /* slate-600 */
            --icon-color-active: #4f46e5; /* indigo-600 */
        ...
        [data-theme="dark"] {
            /* Dark Theme - Refreshed Palette */
            --bg-color-start: #020617; /* slate-950 */
            --bg-color-end: #0f172a; /* slate-900 */
            --bg-color: #020617; /* Fallback */
            --bg-color-2: #1e293b; /* slate-800 for cards, inputs */
            ...
            --icon-color-active: #a5b4fc; /* indigo-300 */
